<?php
    ...
    $postData     = $author_class->getPostDetails();     
    $AuthorData     = $author_class->getAuthorDetails();     
    // echo "<pre>";
        ...
        <div class="row">
          ...
          <div class="col-md-9 cont">
            <div class="row post_cate page_div">
              ...
              <div class="col-lg-4 col-md-6 col-12 mb-4 single-item">
                <div class="post-entry-1 h-100">
                  <div class="position-relative">
                    <input type="hidden" name="postid" id="postid" value="<?php echo $values['POST_ID']; ?>">
                    <a href="single.php?id=<?php echo $values['POST_ID']; ?>">
                      <img src="images/img_1.jpg" alt="Image"
                       class="img-fluid">
                    </a>
                    <button type="button" class="btn btn--action btn--action-edit btn-warning btnedit" data-id="<?php echo $values['POST_ID']; ?>"><i class="fas fa-edit"></i></button>
                    <button type="button" class="btn btn--action btn--action-del btn-danger btndelete" data-id="<?php echo $values['POST_ID']; ?>"><i class="fas fa-trash"></i></button>
                  </div>
