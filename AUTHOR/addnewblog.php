...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
              ...
              <div class="row">
                <div class="col-sm-12 col-lg-6 col-md-6">
                  <div class="form-group">
                    ...
                    <select class="form-control arrow-togglable" id="category" name="category">
                      <option>--Select Category--</option>
                      <?php
                        foreach ($categoryList as $key => $value) {
                      ?>
                          <option id="<?php echo $value['CATEGORY_ID']; ?>"><?php echo $value['TITLE']; ?></option>
                      <?php
                        }
                      ?>
                    </select>
              ...
              <div class="row">
                <div class="col-sm-12 col-lg-6 col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="summ" name="summary">
                  </div>
                </div>
              </div>
              <div class="row">
    ...
    <script src="js/addnewblog.js"></script>
